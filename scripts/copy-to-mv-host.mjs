...
try {
  ...
  console.error(
    'Missing .r3d-local.json. See docs/r3d-presentation-scenes.md before running copy:mv.',
  );
  throw error;
}
...
console.log(`Copied R3D Visual Stage plugin and validation scene assets into ${mvProjectPath}`);
